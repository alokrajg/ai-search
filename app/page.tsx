...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 relative overflow-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-8 py-6 backdrop-blur-md bg-white/90 border-b border-white/20 shadow-sm transition-all duration-300">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link
              href="/dashboard"
              className="bg-gradient-to-r from-primary-500 to-secondary-500 text-white px-8 py-3 rounded-full font-semibold hover:shadow-lg transition-all duration-300 transform hover:scale-105 text-lg"
            >
              Get Started
            </Link>
          </div>
      ...
      <section className="px-4 py-24 bg-gradient-to-br from-gray-50 to-blue-50 relative">
      ...
      <section
        id="features"
        className="px-4 py-24 bg-gradient-to-br from-gray-50 to-blue-50 relative"
      >
        <DetailedFeatures />
      </section>
      ...
      {/* FAQ Section */}
      <section id="faq" className="px-4 py-24 bg-white/50 relative">
        <FAQ />
      </section>
      ...
      <section className="px-4 py-24 relative">
        <div className="max-w-[1400px] mx-auto text-center">
          <div className="relative bg-gradient-to-r from-primary-500 to-secondary-500 rounded-3xl p-16 text-white overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <Link
                href="/dashboard"
                className="group/btn inline-flex items-center justify-center px-10 py-5 text-xl font-semibold text-primary-600 bg-white rounded-full hover:shadow-2xl transition-all duration-300 transform hover:scale-105 relative overflow-hidden"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-primary-50 to-secondary-50 opacity-0 group-hover/btn:opacity-100 transition-opacity duration-300" />
